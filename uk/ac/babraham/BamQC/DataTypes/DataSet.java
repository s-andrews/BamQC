...
import uk.ac.babraham.BamQC.Utilities.LongVector;
import uk.ac.babraham.BamQC.Utilities.ThreadSafeIntCounter;
import uk.ac.babraham.BamQC.Utilities.ThreadSafeLongCounter;
import uk.ac.babraham.BamQC.Utilities.ThreadSafeMinMax;
...
public class DataSet extends DataStore implements Runnable {
	...
	public void addData (Chromosome chr, long read) throws BamQCException {
	 ...
	 * @throws BamQCException if this DataSet has been finalised.
	 */
	public void addData (Chromosome chr, long read, boolean skipSorting) throws BamQCException {
...
//			System.err.println("Cache miss for "+this.name()+" requested "+c+" but last cached was "+lastCachedChromosome);
	...
	/* (non-Javadoc)
	 * @see uk.ac.babraham.BamQC.DataTypes.DataStore#getReadCountForStrand(int strand)
	 */
	@Override
...
//				System.err.println("Sorting unsorted reads");
			...
			try {
				tempFile = File.createTempFile("seqmonk_data_set", ".temp", BamQCPreferences.getInstance().tempDirectory());
