...
public class UpdateChecker {
	 ...
	 * @throws BamQCException if we were unable to check for an update
	 */
	public static boolean isUpdateAvailable () throws BamQCException {
		if (latestVersion == null) {
			getLatestVersionNumber();
		}
		return UpdateChecker.isNewer(BamQCApplication.VERSION, latestVersion);
	}
	...
	/**
	 * Gets the latest version number from the main BamQC site
	 * 
	 * @return The version string from the remote site
	 * @throws BamQCException if the remote version couldn't be retrieved
	 */
	public static String getLatestVersionNumber () throws BamQCException  {
