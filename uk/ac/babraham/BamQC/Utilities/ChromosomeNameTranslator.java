...
public class ChromosomeNameTranslator {
	 ...
	 * @throws BamQCException Thrown if this chromosome is not in the genome used to instantiate the class
	 */
	 ...
	 * @throws BamQCException If we couldn't match the name to any chromosome
	 */
	public ChromosomeWithOffset getChromosomeForName (String name, boolean rememberFailures) {
		 ...
		 * 
		 * If a name can't be matched to a real chromosome then a BamQC exception
		 * will be thrown.
		 */
