 ...
 */
public class GTFParser extends AnnotationParser {
	 ...
	 */
	public GTFParser (Genome genome) {
		super(genome);		
	}
...
//						System.out.println("Adding feature "+sections[2]+" to GFFv3 parent "+parents[p]);
						...
						if (!groupedFeatures.containsKey(sections[2]+"_"+parents[p])) {
							...
							groupedFeatures.put(sections[2]+"_"+parents[p], new Transcript(feature));
...
//					System.out.println("Adding feature "+sections[2]+" to GTF parent "+keyValuePairs.get("trancript_id").elementAt(0));
					...
					if (! groupedFeatures.containsKey(sections[2]+"_"+keyValuePairs.get("transcript_id").elementAt(0))) {
						...
						groupedFeatures.put(sections[2]+"_"+keyValuePairs.get("transcript_id").elementAt(0), new Transcript(feature));
					}						
					...
					if (keyValuePairs.containsKey("ID")) {
						...
						groupedFeatures.put(sections[2]+"_"+keyValuePairs.get("ID").elementAt(0), new Transcript(feature));
